...
CKPT=$ROOT/basetraining/B2N_ucf101_froster
OUT_DIR=$CKPT/testing
LOAD_CKPT_FILE=$ROOT/basetraining/B2N_ucf101_froster/wa_checkpoints/swa_2_12.pth
...
python -W ignore -u tools/run_net.py \
    ...
    VAL_FILE $VAL_FILE \
    TEST_FILE $TEST_FILE \
    DATA.PATH_PREFIX /data/datasets/UCF101/UCF-101/ \
